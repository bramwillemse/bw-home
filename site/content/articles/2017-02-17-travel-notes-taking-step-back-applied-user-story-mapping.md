...
My blog is not very suited to it, but I&#8217;m going to try and make this post visual. Because that&#8217;s what today mainly was about: getting out all my ideas and make a choice on what to prototype.<!--more-->

_If you missed earlier updates, check them out [in the Travel Notes archive][1]!_

## Applied user story mapping

So I don&#8217;t want to talk too much about the idea of _Applied USM_. Let me just show you what I did and you might get the idea. The steps in short:

  1. 1. Create the backbone of the process: **the user&#8217;s journey**. A chronological list of steps or actions the user would take.
  2. 2. **Group** the actions.
  3. 3. **Brainstorm** by adding as much ideas to the actions as possible
  4. 4. **Vote and arrange** the ideas
  5. 5. **Prioritise!**
